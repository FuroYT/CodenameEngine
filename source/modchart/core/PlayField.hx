...
import modchart.core.util.Constants.ModAlias;
import modchart.core.util.Constants.NodeFunction;
import modchart.core.util.Constants.Node;
...
class PlayField extends FlxBasic {
	...
	private function __drawPlayField() {
		...
		for (i=>r in [receptorRenderer, arrowRenderer, holdRenderer, attachmentRenderer])
			r.sort();
